 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'hornetalcala\admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@hornetalcala/admin/views/layouts/main.php';
    /**
     * @var array 
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('hornetalcala\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
