...
namespace hornetalcala\admin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use hornetalcala\admin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\hornetalcala\admin\models\Menu]].
 * 
