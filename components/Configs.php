...
namespace hornetalcala\admin\components;
 ...
 * 
 * ```
 * Yii::$container->set('hornetalcala\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
{
    const CACHE_TAG = 'hornetalcala.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'hornetalcala.admin.configs', []);
